          ...
          <View style={{ flexDirection: 'row', justifyContent: 'space-between', alignItems: 'center' }}>
            ...
            <View
              ...
              <Text
                ...
                style={{ color: '#fff', fontWeight: 'bold' }}>Đang mở cửa</Text>
            </View>
            <TouchableOpacity>
        ...
        <ScrollView horizontal showsHorizontalScrollIndicator={false}>
          ...
          <View style={{
            ...
            <View style={{
              ...
              {placeholderImage ? (
                <Image source={{ uri: placeholderImage }} style={{ height: height * 0.12, borderRadius: 10 }} />
              ) : (
                <Text style={{ fontSize: 14, color: '#fff' }}>Ảnh món ăn</Text>
              )}
            </View>
            <Text style={{ fontSize: 14, fontWeight: 'bold', color: '#333' }}>Gỏi cuốn</Text>
          ...
          <View style={{
            ...
            <Text style={{ fontSize: 14, fontWeight: 'bold', color: '#333' }}>Nhà Nghi</Text>
      ...
      <View style={{ padding: 20 }}>
        ...
        <View style={{
          ...
          <View style={{ flex: 1, justifyContent: 'center', paddingLeft: 10 }}>
            ...
            <Text style={{ fontSize: 14, fontWeight: 'bold', color: '#333' }}>Cơm gà xối mỡ</Text>
        ...
        <View style={{
          ...
          <View style={{ flex: 1, justifyContent: 'center', paddingLeft: 10 }}>
            <Text style={{ fontSize: 14, color: '#333' }}>4.5 ⭐ (25+)</Text>
            <Text style={{ fontSize: 14, fontWeight: 'bold', color: '#333' }}>Cơm tấm sườn</Text>
            <Text style={{ fontSize: 14, color: '#333' }}>45.000 VND</Text>
          </View>
        </View>
      </View>
